...
/**
 * Servlet implementation class DesinscreverseEvento
 */
@WebServlet("/DesinscreverseEvento")
public class DesinscreverseEvento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesinscreverseEvento() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		InscricaoDAO.removerInscricao(aluno, evento);
